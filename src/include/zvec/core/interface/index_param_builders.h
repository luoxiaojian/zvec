...
class FlatIndexParamBuilder
 ...
 public:
  ...
  FlatIndexParamBuilder &WithUseContiguousMemory(bool use_contiguous_memory) {
...
class VamanaIndexParamBuilder
 ...
 public:
  ...
  VamanaIndexParamBuilder &WithUseBulkBuild(bool use_bulk_build) {
    param->use_bulk_build = use_bulk_build;
    return *this;
  }
