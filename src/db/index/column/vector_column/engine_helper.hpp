    ...
    switch (field_schema.index_params()->type()) {
      ...
      case IndexType::HNSW: {
        ...
        if (query_params.query_params) {
          ...
          hnsw_query_param->prefetch_offset = static_cast<uint32_t>(
              db_hnsw_query_params->prefetch_offset());
          hnsw_query_param->prefetch_lines = static_cast<uint32_t>(
      ...
      case IndexType::VAMANA: {
        ...
        if (query_params.query_params) {
          ...
          vamana_query_param->prefetch_offset = static_cast<uint32_t>(
              db_vamana_query_params->prefetch_offset());
          vamana_query_param->prefetch_lines = static_cast<uint32_t>(
