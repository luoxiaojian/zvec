...
class UniformUint4StreamingReformer : public IndexReformer {
 public:
  UniformUint4StreamingReformer(IndexMeta::DataType /*dst_type*/) {}
  ~UniformUint4StreamingReformer() override = default;
  ...
  int init(const ailego::Params &params) override {
    ...
    if (!has_minimum || !has_range || !has_dimension ||
      ...
      LOG_ERROR("UniformUint4StreamingReformer: invalid or missing params");
...
INDEX_FACTORY_REGISTER_REFORMER_ALIAS(UniformUint4StreamingReformer,
                                      UniformUint4StreamingReformer,
