...
class VamanaEntity {
 public:
  ...
  static constexpr bool kDefaultTwoPassBuild = true;
 ...
 protected:
  ...
  // Transient storage metadata supplied by the query metric. It is not part
  // of the persisted Vamana format; vector_size() remains the encoded record
