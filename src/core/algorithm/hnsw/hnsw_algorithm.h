...
//! Non-template base class for HnswAlgorithm, providing a type-erased
//! interface so that HnswStreamer can hold a pointer without knowing the
//! MemBlockType template parameter.
...
//! hnsw graph algorithm implement, templated on EntityType for search
//! hot path optimization. EntityType should be HnswMmapStreamerEntity or
//! HnswBufferPoolStreamerEntity.
