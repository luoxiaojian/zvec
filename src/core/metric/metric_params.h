...
//! UniformQuantizedInt8 Metric
static const std::string UNIFORM_QUANTIZED_INT8_METRIC_ORIGIN_METRIC_NAME =
    "proxima.uniform_quantized_int8.metric.origin_metric_name";
