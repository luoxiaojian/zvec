...
class VamanaIndexParam(VectorIndexParam):
    ...
    Attributes:
        ...
        use_optimized_build (bool): Enable the grouped optimized construction
            path. Set to False to reproduce the historical construction path.
    ...
    def flat_data_type(self) -> _zvec.typing.DataType:
        """DataType: Physical data type of the refine Flat reference index."""
    @property
    def use_optimized_build(self) -> bool:
        """bool: Whether grouped Vamana construction optimizations are enabled."""
    @property
